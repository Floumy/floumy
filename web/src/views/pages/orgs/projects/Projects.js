                  ...
                  <CardBody className="d-flex flex-column">
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      <h5 className="mb-2 text-xl text-truncate">
                        <Link to={`/admin/orgs/${orgId}/projects/${project.id}/dashboard`}>
                          {project.name}
                        </Link>
                      </h5>
                      <div className="repository-badges">
                        {project.githubRepositoryUrl && (
                          <Link to={project.githubRepositoryUrl} target="_blank">
                    ...
                    {/* Description Section */}
                    <CardText className="text-muted mb-3" style={{
                      display: '-webkit-box',
                      WebkitLineClamp: 2,
                    ...
                    <div className="d-flex justify-content-between align-items-center mt-auto pt-2 border-top">
                      ...
                      <div className="d-flex gap-2">
                        {project?.isBuildInPublicEnabled && (
                          <Link to={`/public/orgs/${orgId}/projects/${project.id}/active-sprint`} target="_blank">
