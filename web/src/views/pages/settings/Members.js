                    ...
                    <thead className="thead-light">
                      <tr>
                        ...
                        <th scope="col" width="20%">
                          ...
                          >
                            <span>
                              <strong>Contributor:</strong> can view and edit
                              the project content.
                              <br />
                              <strong>Admin:</strong> can manage projects and
                              members.
                              <br />
                            </span>
                          </UncontrolledTooltip>
                        ...
                        members.map((member) => (
                          <tr key={member.id}>
                            <td>
                              <span
                                style={{
                                  backgroundColor: textToColor(member.name),
                                }}
                            ...
                            <td>{formatDateWithTime(member.createdAt)}</td>
                            {currentUser?.role === 'admin' && (
                              <td>
