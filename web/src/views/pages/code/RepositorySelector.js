            ...
            <Card className="mb-5">
              ...
              <CardBody>
                <div className="text-center my-2 py-2">
                  <h3 className="mb-2">Connect a code repository</h3>
                  <p className="text-muted mb-4">
                    Link your project to GitHub or GitLab to sync pull requests,
                  ...
                  <Row className="justify-content-center">
                    <Col md="5" className="mb-3">
                      <Card
                        ...
                        className="h-100 shadow-none shadow-none--hover cursor-pointer"
                      >
                        <CardBody className="d-flex align-items-start">
                          ...
                          <div className="text-left">
                            ...
                            <p className="text-muted mb-0 text-sm">
                              Authenticate with GitHub and start syncing your
                              repositories.
                            </p>
                          </div>
                        </CardBody>
                      ...
                      >
                        <CardBody className="d-flex align-items-start">
                          ...
                          <div className="text-left">
                            ...
                            <p className="text-muted mb-0 text-sm">
                              Connect to GitLab and manage merge requests and
                              issues.
                            </p>
                          </div>
                        </CardBody>
