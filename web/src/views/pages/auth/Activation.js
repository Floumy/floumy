              ...
              <div className="header-body text-center mb-7">
                <Row className="justify-content-center">
                  <Col className="px-5" lg="6" md="8" xl="5">
                    {loading && (
                      <i className="fas fa-spinner fa-spin fa-7x text-white"></i>
                    )}
                    {!loading && success && (
                      <>
                        ...
                        <p className="text-lead text-white">
                          Your account’s live and ready. Jump into your
                          dashboard and start making those big ideas happen.
                          Let’s do this!
                        </p>
                        <h3>
                    ...
                    {!loading && !success && (
                      <>
                        ...
                        <p className="text-lead text-white">
                          {' '}
                          Looks like the link is expired or broken. Check your
                          email for a new one or hit up support. Let’s sort this
                          out and get you rolling on Floumy!
                        </p>
                        <br />
