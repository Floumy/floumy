                ...
                <Row className="justify-content-center">
                  <Col className="px-5" lg="6" md="8" xl="5">
                    ...
                    <p className="text-lead text-white">
                      We've sent a password reset link to your email. It's your
                      ticket back to the Floumy universe! If it doesn't appear
                      within a few moments, don't forget to check your spam or
                      promotions folder. Ready to reset and resume your creative
                      journey?
                    </p>
                    <h3>
