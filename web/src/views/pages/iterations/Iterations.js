...
function Iterations() {
  ...
  useEffect(() => {
    ...
    async function fetchIterations() {
      ...
      try {
        const iterations = await listIterationsWithWorkItemsForTimeline(timelineFilterValue);
  ...
  useEffect(() => {
    async function fetchBacklogWorkItems() {
      try {
        ...
        const workItems = await listOpenWorkItems();
                ...
                {iterations.length === 0 && !isLoadingIterations && (
                  <div style={{ maxWidth: "600px" }} className="mx-auto font-italic">
                    ...
                    <p>Sprints are short, time-boxed periods during which your team works to complete specific
                      ...
                      <br />
                      <Link to={"/admin/iterations/new"} className="text-blue font-weight-bold">Plan a Sprint</Link>
                    </p>
                    <h3>Work Items</h3>
                    <p>Work Items are the tasks and activities that need to be completed to develop your features.
                      ...
                      <br />
                      <Link to={"/admin/work-item/new"} className="text-blue font-weight-bold">Create a Work
                        Item</Link>
                    </p>
                  </div>
                )}
                    ...
                    <Row className="pl-4 pt-2 pr-4">
                      <Col>
                        <h3 className="mb-0">
                          ...
                          <Link to={`/admin/iterations/edit/${iteration.id}`} className="mr-2">
                            <span
