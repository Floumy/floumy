                                    ...
                                    <Form
                                        ...
                                        <Row className="mb-3">
                                            <Col>
                                                ...
                                                >
                                                    {initiative ? <Link
                                                        to={`/admin/orgs/${orgId}/projects/${projectId}/roadmap/initiatives/detail/${initiative}`}>
                                                        Initiative
                                        ...
                                        <Row className="mb-0">
                                            <Col>
                                                ...
                                                <FloumyDropZone onFilesChanged={handleFilesChanged}
                            ...
                            <Row>
                                <Col>
                                    ...
                                    <ul className="list-unstyled">
                                        ...
                                        {workItem.branches?.map((branch) => (
                                            <li key={branch.id} className="mb-2">
                                                {branch.state === 'closed' ?
                                                    <>
                                                        <UncontrolledTooltip target={'closed-branch-' + branch.id} placement="top">
                                                            The branch is closed
                                                        </UncontrolledTooltip>
                                                        <i className="fa fa-times-circle mr-2 text-danger" id={'closed-branch-' + branch.id} />
                                                        <span style={{textDecoration: 'line-through'}}>{branch.name}</span>
                                                    </> :
                                    ...
                                    <ul className="list-unstyled">
                                        ...
                                        {workItem.pullRequests?.length === 0 &&
                                            <li className="mb-2">No {workItem.codeConnectionType === 'gitlab' ? 'merge requests' : 'pull requests'} found</li>}
                                    </ul>
                                </Col>
                            </Row>
                        </CardBody>
