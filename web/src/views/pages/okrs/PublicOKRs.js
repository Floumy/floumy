                        ...
                        <Card className="card-stats">
                            <CardBody>
                                ...
                                <p className="mt-3 mb-0 text-sm">
                                    ...
                                    <span
                                        className="text-nowrap ml-2">{stats.objectives.inProgress} in progress</span>
                                </p>
                            </CardBody>
                        </Card>
                    </Col>
                        ...
                        <Card className="card-stats">
                            <CardBody>
                                ...
                                <p className="mt-3 mb-0 text-sm">
                                    ...
                                    <span
                                        className="text-nowrap ml-2">{stats.keyResults.inProgress} in progress</span>
                                </p>
                            </CardBody>
                        </Card>
                    </Col>
                        ...
                        <Card>
                            ...
                            {!isLoading && okrs.length > 0 &&
                                <div className="table-responsive">
                                    <Table className="align-items-center table-flush no-select"
                                            ...
                                            <tr key={okr.id}>
                                                ...
                                                {okr.id === 0 &&
                                                    <td colSpan={5} className={"text-center"}>
                                                        <h3 className="text-center m-0">No objectives found for this
                                                            timeline.</h3>
                                                    </td>
                                                }
                                                {okr.id !== 0 &&
                                                    <>
                                                        ...
                                                        <td>
                                                            <div className="d-flex align-items-center">
                                                                <span
                                                                    className="mr-2">{formatOKRsProgress(okr.progress)}%</span>
                                                                <div>
                                                                    <Progress max="100"
                                                        ...
                                                        <td>
                                                            <Badge color="" className="badge-dot mr-4">
                                                                ...
                                                                <span
                                                                    className="status">{formatHyphenatedString(okr.status)}</span>
                                                            </Badge>
                                                        </td>
                                                    </>
                                                }
