...
export class GithubController {
    ...
    @Get('auth/orgs/:orgId/projects/:projectId/github/prs/cycle-time')
    async getPullRequestCycleTime(
        ...
        try {
            return await this.githubService.getPRsCycleTime(orgId, projectId, parseInt(timeframeInDays));
        } catch (e) {
            throw new BadRequestException(e.message);
        }
    }

    @Get('auth/orgs/:orgId/projects/:projectId/github/prs/merge-time')
    async getPullRequestMergeTime(
        ...
        try {
            return await this.githubService.getAverageMergeTime(orgId, projectId, parseInt(timeframeInDays));
        } catch (e) {
            throw new BadRequestException(e.message);
        }
    }
