...
export class GithubController {
  ...
  async getPullRequestCycleTime(
    ...
    try {
      return await this.githubService.getPRsCycleTime(
        orgId,
        projectId,
  ...
  async getPullRequestMergeTime(
    ...
    try {
      return await this.githubService.getAverageMergeTime(
        orgId,
        projectId,
        parseInt(timeframeInDays),
      );
  ...
  async getPullRequestFirstReviewTime(
    ...
    try {
      return await this.githubService.getAverageFirstReviewTime(
        orgId,
        projectId,
        parseInt(timeframeInDays),
      );
